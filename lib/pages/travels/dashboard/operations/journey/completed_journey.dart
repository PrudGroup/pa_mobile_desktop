...
class CompletedJourneyState extends State<CompletedJourney> {
  List<JourneyWithBrand> journeys = busNotifier.brandCompletedJourneys;
  bool loading = false;
  ...
  Future<void> getJourneyFromCloud() async {
    await tryAsync("getJourneyFromCloud", () async {
      ...
      List<JourneyWithBrand> found = await busNotifier.getBrandJourneysFromCloud(5, busNotifier.busBrandId!);
      if(mounted) {
