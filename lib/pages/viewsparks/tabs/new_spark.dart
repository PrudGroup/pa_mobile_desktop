...
class NewSparkState extends State<NewSpark> {
  ...
  List<String> categories = [
    "youtube", "prudapp", "telegram", "instagram", "twitch", "tiktok", "facebook", "twitter", "spotify",
    "discord", "soundcloud", "trovo", "linkedin", "reddit", "trustpilot", "vk", "dzen",
    "yelp", "kick", "likee", "threads", "rutube", "rumble", "truth", "playstore", "appstore", "website"
  ];
  List<String> locationTargets = ["global", "country", "countries", "towns", "town", "state", "states", "city", "Cities"];
  List<String> sparkTypes = ["views", "traffic", "subscribe", "likes", "follow", "all"];
  ...
  Future<bool> savePaymentToCloud(String payId) async{
    ...
    try{
      await registerSpark();
      if(myStorage.user != null && myStorage.user!.id != null && newSpark.id != null) {
  ...
  bool validateEntries() {
    ...
    return newSpark.locationTarget != null && newSpark.sparkCategory != null &&
      newSpark.sparkType != null && newSpark.targetSparks != null &&
      newSpark.targetLink != null && newSpark.title != null &&
      newSpark.description != null && newSpark.duration != null;
  }
  ...
  void _goBack(){
    if(mounted){
      setState(() {
        switch(presentPhase){
          case SparkCreationPhase.first: presentPhase = SparkCreationPhase.info;
          case SparkCreationPhase.second: presentPhase = SparkCreationPhase.first;
          case SparkCreationPhase.third: presentPhase = SparkCreationPhase.second;
          case SparkCreationPhase.fourth: presentPhase = SparkCreationPhase.third;
          case SparkCreationPhase.fifth: presentPhase = SparkCreationPhase.fourth;
          case SparkCreationPhase.sixth: presentPhase = SparkCreationPhase.fifth;
          case SparkCreationPhase.payment: presentPhase = SparkCreationPhase.sixth;
          default: presentPhase = SparkCreationPhase.payment;
        }
      });
    }
  }
  ...
  void _next(){
    if(mounted){
      setState(() {
        switch(presentPhase){
          case SparkCreationPhase.info: presentPhase = SparkCreationPhase.first;
          case SparkCreationPhase.first: presentPhase = SparkCreationPhase.second;
          case SparkCreationPhase.second: presentPhase = SparkCreationPhase.third;
          ...
          case SparkCreationPhase.fourth: if(validateLocations()) presentPhase = SparkCreationPhase.fifth;
          case SparkCreationPhase.fifth: {
            getTotal();
            presentPhase = SparkCreationPhase.sixth;
          }
          case SparkCreationPhase.sixth: presentPhase = SparkCreationPhase.payment;
          case SparkCreationPhase.payment: presentPhase = SparkCreationPhase.success;
          default: presentPhase = SparkCreationPhase.failed;
        }
      });
    }
  }
    ...
    Future.delayed(Duration.zero, () async {
      try{
        if(costs.isEmpty) {
          ...
          }else{ if(mounted) setState(() => hasError = true);}
        }
  ...
  String getCost(String platform){
    String res = "";
    if(costs.isNotEmpty){
      List<SparkCost> dCosts = costs.where((SparkCost sct) => sct.platform?.toLowerCase() == platform.toLowerCase()).toList();
  ...
  double getTotal(){
    ...
    if(newSpark.sparkCategory != null) {
      List<SparkCost> dCosts = costs.where((SparkCost sct) =>
      sct.platform?.toLowerCase() == newSpark.sparkCategory!.toLowerCase())
          .toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:  AppBar(
        ...
        actions: [
          if(presentPhase == SparkCreationPhase.info && hasError) IconButton(
            icon: const Icon(Icons.refresh),
            onPressed: getCosts,
            color: prudColorTheme.buttonD,
          ),
          if(presentPhase != SparkCreationPhase.info) IconButton(
        ...
        child: SingleChildScrollView(
          ...
          Column(
            children: [
              spacer.height,
              Translate(
                text: "Kindly read through our terms and policies with regard to 'Sparks'. "
              ...
              Flex(
                ...
                children: [
                  getTextButton(
                    ...
                    onPressed: () => iCloud.goto(context, const LegalPage())
                  ),
                  getTextButton(
                    title: "Youtube",
                  ...
                  gettingCost? SpinKitFadingCircle(
            ...
            Column(
              children: [
                ...
                FormBuilderChoiceChip(
                  ...
                  options: categories.map((String e) => FormBuilderChipOption(
                    value: e,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Translate(
                          style: prudWidgetStyle.btnTextStyle.copyWith(
                            color: e == selectedCategory? prudColorTheme.bgA : prudColorTheme.primary
                          ),
                          text: e
                        ),
                        Text(
                ...
                child: Column(
                  children: [
                    ...
                    FormBuilderChoiceChip(
                      ...
                      backgroundColor: prudColorTheme.bgA,
                      shape: prudWidgetStyle.choiceChipShape,
                      options: locationTargets.map((String e) => FormBuilderChipOption(
                        value: e,
                        child: Translate(
                            style: prudWidgetStyle.btnTextStyle.copyWith(
                                color: e == selectedTarget? prudColorTheme.bgA : prudColorTheme.primary
                            ),
                            text: e
                        ),
                      )).toList(),
                        ...
                        child: Column(
                          children: [
                            ...
                            FormBuilderTextField(
                              initialValue: newSpark.targetLink?? "",
                              name: 'link',
                              autofocus: true,
                              ...
                              onChanged: (dynamic value){
                                if(mounted && value != null) {
                                  setState(() {
                                    newSpark.targetLink = value!.trim();
                                  });
                                }
                              },
                            ...
                            spacer.height,
                            Translate(
                              text: "How many likes, views, subscriptions, or followership do you target.",
                              style: prudWidgetStyle.tabTextStyle.copyWith(
                            ...
                            FormBuilderTextField(
                              initialValue: "${newSpark.targetSparks?? 0}",
                              name: 'sparks',
                              style: tabData.npStyle,
                              ...
                              onChanged: (dynamic value){
                                try{
                                  if(mounted && value != null) {
                                    setState(() {
                                      newSpark.targetSparks = int.tryParse(value!.trim());
                                    });
                                  }
                                }catch(ex){
                                  debugPrint("error: $ex");
                              ...
                              validator: FormBuilderValidators.compose([
                                ...
                                FormBuilderValidators.max(1000000000),
                              ]),
                            ),
                            spacer.height,
                            FormBuilderTextField(
                            ...
                            spacer.height,
                            FormBuilderTextField(
                              initialValue: newSpark.description?? "",
                              name: 'description',
                              style: tabData.npStyle,
                              keyboardType: TextInputType.text,
                              ...
                              onChanged: (dynamic value){
                                try{
                                  if(mounted && value != null) {
                                    setState(() {
                                      newSpark.description = value!.trim();
                                    });
                                  }
                                }catch(ex){
                                  debugPrint("$ex");
                            ...
                            spacer.height,
                            Translate(
                              text: "How long do you want to retain intended subscribers, viewers, and followers? This will "
                            ...
                            FormBuilderTextField(
                              initialValue: "${newSpark.duration?? 0}",
                              name: 'duration',
                              style: tabData.npStyle,
                              keyboardType: TextInputType.number,
                              decoration: getDeco("Duration (Months)"),
                              onChanged: (dynamic value){
                                try{
                                  if(mounted && value != null) {
                                    setState(() {
                                      newSpark.duration = int.tryParse(value!.trim());
                                    });
                                  }
                                }catch(ex){
                                  debugPrint("$ex");
                ...
                (
                      ...
                      PrudPanel(
                        ...
                        child: Column(
                          children: [
                            ...
                            spacer.height,
                            Translate(
                              text: "Add all the intended countries you want your viewers to be based in. "
                            ...
                            CountriesPicker(
                              isMultiple: selectedTarget == "countries"? true : false,
                            ...
                            spacer.height,
                            spacer.height,
                            if(allStates.isNotEmpty) StatesPicker(
                              isMultiple: selectedTarget == "states"? true : false,
                              selected: newSpark.targetStates,
                              allStates: allStates,
                              onChange: (List<String> selected, String? firstStateCode){
                                try{
                            ...
                            if(showTown && selectedTarget!.indexOf("town") == 0) PrudPanel(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  spacer.height,
                                  Translate(
                                    text: "Type out your target town(s). If it's more than one town, separate them with a comma.",
                                    style: prudWidgetStyle.tabTextStyle.copyWith(
                                      color: prudColorTheme.secondary,
                                      fontSize: 12,
                                      fontWeight: FontWeight.w500
                  ...
                  (
                      ...
                      Column(
                        children: [
                          spacer.height,
                          if(selectedCategory != null && newSpark.targetSparks != null) FigureDisplay(
                            title: selectedCategory!,
                            per: "Spark",
                            perFigure: double.parse(getCost(selectedCategory!)),
                            quantity: newSpark.targetSparks!,
                            desc: _convertLocationTargetsToString(),
                          ...
                          spacer.height,
                          Translate(
                            text: "We will provide you with audience and influencers who are interested in your content and"
                      ...
                      (
                          ...
                          Column(
                            children: [
                              ...
                              spacer.height,
                              Translate(
                                text: "We are working round the clock to make payment as easy as possible. "
                              ...
                              (
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      spacer.height,
                                      Translate(
                                        text: "Great! You have successfully created a spark for your brand. Visit "
